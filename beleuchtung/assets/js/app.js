...
var vue = new Vue({
  ...
  methods: {
    createMap() {
      ...
      this.map = new mapboxgl.Map({
        container: 'map',
        style: window.location.origin + '/public/spider/beleuchtung/mapbox-style.json',
    ...
    loadMyLayers() {
      ...
      map.on('click', 'beleuchtung_knoten', openPopup)
      map.on('click', 'beleuchtung_label', openPopup);
  ...
  watch: {
    ...
    'vectorLayers.fernwaerme':  function (newVal, oldVal){
      this.switchLayerVisibility('fernwaerme', newVal);
    },
